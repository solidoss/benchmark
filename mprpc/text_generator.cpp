...
bool parseArguments(Parameters& _par, int argc, char* argv[])
{
    ...
    try {
        ...
        desc.add_options()("help,h", "List program options")(
            ...
            value<size_t>(&_par.max_word_size)->default_value(128),
            "Max word size")(
            "min-line-size,l", value<size_t>(&_par.min_line_size)->default_value(4),
            "Min line size")(
            "max-line-size,L",
            value<size_t>(&_par.max_line_size)->default_value(1024 * 4),
            "Max line size")("line-count,C",
            value<size_t>(&_par.line_count)->default_value(20),
            "Line count")(
