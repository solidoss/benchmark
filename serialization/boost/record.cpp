...
void to_string(const Record& record, std::string& data)
{
    ...
    // boost::archive::binary_oarchive archiver(stream, boost::archive::no_header
    // | boost::archive::no_codecvt | boost::archive::no_tracking);
...
void from_string(Record& record, const std::string& data)
{
    ...
    // boost::archive::binary_iarchive archiver(stream, boost::archive::no_header
    // | boost::archive::no_codecvt | boost::archive::no_tracking);
